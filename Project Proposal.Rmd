...
territory. In other words, the possibility to analyse if the activity is fully optimised may
give to the client a new point of view to **eventually reorganise the approach and the work on the area where can proved a lack of performance**. In this perspective, with the data
...
of the deliveries, as well as which specific days or moment of the day can affect the
...
during this phase.
In addition, the **addresses, a vital variable for the analysis, will be converted into geographic coordinates** in order to give the possibility to track the route of each driver
during his activity of delivery.
